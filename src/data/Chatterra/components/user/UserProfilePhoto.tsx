  ...
  return (
    ...
    >
      {userProfile?.avatar_url ? (
        ...
        <div
          className={`${sizeClasses[size]} rounded-full bg-linear-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold group-hover:scale-105 transition-transform duration-300`}
        >
